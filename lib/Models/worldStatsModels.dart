...
class WorldStatsModels {
  ...
  WorldStatsModels.fromJson(dynamic json) {
...
WorldStatsModels copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStatsModels(  updated: updated ?? _updated,
  cases: cases ?? _cases,
